  ...
  return (
    <div className="w-full max-w-3xl mx-auto flex item-center justify-between">
      ...
      <Dialog.Root>
        ...
        <Dialog.Portal>
          <Dialog.Overlay className="w-screen h-screen bg-black/80 fixed inset-0 transition-transform" />

          <Dialog.Content className="absolute p-10 bg-zinc-900 rounded-2xl w-full max-w-md top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transition-transform">
